...
## Load data
df = CSV.read("data/booking_semisynth_cont_sample.csv", DataFrame, threaded = false)
...
if regenerate_data
    ...
    ## Export
    CSV.write("data/booking_semisynth_cont_sample.csv", df)
end
...
for nn in 1:nruns
    ...
    CSV.write("data/semisynth_cont_booking/TE_MBTR_post.csv", TE_Krobustness_df)
    CSV.write("data/semisynth_cont_booking/TE_MBTR_median.csv", TE_Krobustness_medians_df)
end
...
TE_Krobustness_df = CSV.read("data/semisynth_cont_booking/TE_MBTR_post.csv", DataFrame)
TE_Krobustness_df = TE_Krobustness_df[TE_Krobustness_df.BTR_noCVEM_K5 .!= 0.,:]
TE_Krobustness_df = TE_Krobustness_df[:,[:NoText_reg, :BTR_noCVEM_K5, :BTR_noCVEM_K10, :BTR_noCVEM_K20,
    :BTR_noCVEM_K30, :BTR_noCVEM_K50]]

if save_files
    #CSV.write("data/semisynth_cont_booking/TE_Krobustness.csv",TE_Krobustness_df1)
end

TE_Krobustness_df1 = CSV.read("data/semisynth_cont_booking/TE_Krobustness.csv",DataFrame)
TE_Krobustness_df1 = TE_Krobustness_df1[:,[:NoText_reg, :LDA_K5, :LDA_K10, :LDA_K20, :LDA_K30, :LDA_K50,
    :sLDA_K5, :sLDA_K10, :sLDA_K20, :sLDA_K30, :sLDA_K50]]


scholar_df = CSV.read("data/semisynth_cont_booking/scholar/semisynth_booking_CT_scholar_regweight_bootstrap_noCV.csv", DataFrame)
...
# Add scholar results
plot!(Ks, scholar_df.w1_median, color = :pink, label = "rSCHOLAR")
